(function ()
{
    ...
    var aneOb, fruitOb, momOb, babyOb;
    var scoreOb, waveOb, haloOb;
    var mx, my;
    var dustOb;
    window.jzk = {};
    ...
    jzk.gameLoop = function ()
    {
        ...
        ctx2.clearRect(0, 0, canWid, canHei);
    ...
    jzk.momFoodBaby = function ()
    {
        if (scoreOb.fruitNum > 0)
        {
            ...
            if (len < 30)
            {
                ...
                babyOb.babyBodyIndex = index;
                scoreOb.computeScore()
            }
        }
    };
    window.can2App = {};
    ...
    aneObject.prototype.drawAne = function ()
    {
        ...
        for (var i = 0; i < this.num; i++)
        {
            ...
            ctx2.quadraticCurveTo(this.rootx[i], canHei - 100, endx, this.heady[i]);
            ctx2.stroke()
        }
        ctx2.restore()
    };
    ...
    fruitObject.prototype.drawFruit = function ()
    {
        for (var i = 0; i < this.num; i++)
        {
            if (this.alive[i])
            {
                ...
                ctx2.drawImage(pic, this.x[i] - this.size[i] * 0.5, this.y[i] - this.size[i] * 0.5, this.size[i],
                    this.size[i]);
                if (this.y[i] < 8) {
                    this.alive[i] = false;
                }
    ...
    fruitObject.prototype.born = function (i)
    {
        ...
        this.x[i] = aneOb.headx[aneId];
        this.y[i] = aneOb.heady[aneId];
        this.size[i] = 0;
        this.alive[i] = true;
    ...
    waveObject.prototype.drawWave = function ()
    {
        ctx1.save();
        ctx1.lineWidth = 3;
        for (var i = 0; i < this.num; i++)
